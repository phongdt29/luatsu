...
<div class="reset_password" id="customer_login">
    ...
    <form method="post" class="lost_reset_password">
		...
		<p class="woocommerce-form-row form-row">
			<input class="woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_login" id="user_login" autocomplete="username"  placeholder="<?php esc_html_e( 'Username or email', 'eduma' ); ?>" aria-label="<?php esc_attr_e( 'Username or email', 'eduma' ); ?>"/>
