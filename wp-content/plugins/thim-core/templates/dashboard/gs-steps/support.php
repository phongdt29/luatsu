<div class="top">
    ...
    <div>
        <div class="text-success">Item Support can be accessed from <a href="https://help.thimpress.com/" target="_blank">ThimPress</a> and includes:</div>
        ...
        <ul class="tc-list">
            ...
            <li>Installation Services (this can be available if you contact our support team via <a href="http://help.thimpress.com/" target="_blank">our forum</a> )
            </li>
