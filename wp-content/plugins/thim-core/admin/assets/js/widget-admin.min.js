var obEmitters = {
    ...
    '_checker': function(val, args, matchPart, callback) {
        ...
        for (var i = 0; i < args.length; i++) {
            m = obEmitters._match(args[i], matchPart);
            if (m === false) {
                continue;
            }
    ...
    'conditional': function(val, args) {
        return obEmitters._checker(val, args, '[^;{}]*', function(val, args, match) {
            return eval(match);
        });
    },
...
(function($) {
    ...
    $.fn.obSetupForm = function() {
        return $(this).each(function(i, el) {
            var $el = $(el),
                $mainForm, formInitializing = true;
            ...
            if ($el.is('.thim-widget-form-main')) {
                ...
                $el.on('obstatechange', function(e, incomingGroup, incomingState) {
            ...
            $fields.find('> .thim-widget-input-color').wpColorPicker(params)
                .closest('.thim-widget-field').find('a').on('click', function() {
            ...
            $fields.find('> .multi-media-field-wrapper').each(function() {
                ...
                $media
                    .on('click', 'a.multimedia-remove-button', function(e) {
                        e.preventDefault();
            ...
            $fields.filter('.thim-widget-field-type-widget, .thim-widget-field-type-section').find('> label').on('click', function() {
            ...
            var stateEmitterChangeHandler = function() {
                ...
                if (typeof emitters !== 'undefined') {
                    var handleStateEmitter = function(emitter, currentStates) {
                        if (typeof obEmitters[emitter.callback] === 'undefined' || emitter.callback.substr(0, 1) === '_') {
                        ...
                        return $.extend(currentStates, obEmitters[emitter.callback]($$.val(), emitter.args));
                    };
                    ...
                    // Check which states have changed and trigger appropriate obstatechange
                    ...
                    for (var k in states) {
                        if (typeof formStates[k] === 'undefined' || states[k] !== formStates[k]) {
                            ...
                            $mainForm.trigger('obstatechange', [k, states[k]]);
                        }
                    }
    ...
    $.fn.obSetupRepeater = function() {
        ...
        return $(this).each(function(i, el) {
            ...
            $el.find('> .thim-widget-field-repeater-add').disableSelection().on('click', function(e) {
                e.preventDefault();
            ...
            $el.find('> .thim-widget-field-repeater-top > .thim-widget-field-repeater-expend').on('click', function(e) {
                e.preventDefault();
